...
public class PutOffTrainingLikeCommand implements Command {

    private ControllerUtilFactory utilFactory = ControllerUtilFactory.getINSTANCE();
    private ServiceFactory serviceFactory = ServiceFactory.getINSTANCE();
    private UserService userService;

    public PutOffTrainingLikeCommand(){
        userService = serviceFactory.getUserServiceImpl();
    }

    @ConstructorForTest
    public PutOffTrainingLikeCommand(UserService userService, ControllerUtilFactory utilFactory){
    ...
    public String execute() throws CommandException {
        ...
        try {
            if (controllerValueChecker.isNumber(idTraining)){
                ...
                userService.putOffLike(idTrainingInt, idUser);
