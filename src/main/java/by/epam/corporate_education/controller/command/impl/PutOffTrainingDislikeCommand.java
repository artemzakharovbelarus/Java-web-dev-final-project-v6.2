...
public class PutOffTrainingDislikeCommand implements Command {

    private ControllerUtilFactory utilFactory = ControllerUtilFactory.getINSTANCE();
    private ServiceFactory serviceFactory = ServiceFactory.getINSTANCE();
    private UserService userService;

    public PutOffTrainingDislikeCommand(){
        userService = serviceFactory.getUserServiceImpl();
    }

    @ConstructorForTest
    public PutOffTrainingDislikeCommand(UserService userService, ControllerUtilFactory utilFactory){
    ...
    public String execute() throws CommandException {
        ...
        try {
            if (controllerValueChecker.isNumber(idTraining)){
                ...
                userService.putOffDislike(idTrainingInt, idUser);
