...
public class PutTrainingLikeCommand implements Command {

    private ControllerUtilFactory utilFactory = ControllerUtilFactory.getINSTANCE();
    private ServiceFactory serviceFactory = ServiceFactory.getINSTANCE();
    private UserService userService;

    public PutTrainingLikeCommand(){
        userService = serviceFactory.getUserServiceImpl();
    }

    //annotation
    public PutTrainingLikeCommand(UserService userService, ControllerUtilFactory utilFactory){
    ...
    public String execute() throws CommandException {
        ...
        try{
            if (valueChecker.isNumber(idTraining)){
                ...
                userService.addTrainingLike(idTrainingInt, idUser);
