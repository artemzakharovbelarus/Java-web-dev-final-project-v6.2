...
public class RemoveTrainingCommandTest {
    ...
    public void init(){
        ...
        command = new RemoveTrainingCommand(adminService, utilFactory);
    }

    @Test(expected = CommandException.class)
    public void execute_serviceExceptionFromRemoveTraining_commandException_errorPath()
