...
public class ForwardWriteTrainingQueryCommandTest {
    ...
    public void init(){
        ...
        command = new ForwardQueryTrainingCommand(userService, utilFactory);
    }

    @Test(expected = CommandException.class)
    public void execute_serviceExceptionGetTraining_commandException() throws ServiceException, CommandException {
        //given
        //when
    ...
    @Test
    public void execute__commandException_forwardEnroll() throws ServiceException, CommandException {
        //given
        //when
        Mockito.when(request.getParameter(ParameterName.ID_TRAINING)).thenReturn("1");
        ...
        String result = command.execute();
        //then
        String expected = pathCreator.getForwardEnrollTraining();
        assertEquals(expected, result);
    }
}