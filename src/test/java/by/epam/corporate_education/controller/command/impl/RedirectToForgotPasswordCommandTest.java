...
public class RedirectToForgotPasswordCommandTest {
    ...
    public void init(){
        ...
        command = new RedirectToForgotPasswordCommand(utilFactory);
    }
    ...
    public void execute_validParameter_forwardToForgotPassword() throws CommandException {
        ...
        //then
        String expected = pathCreator.getForwardForgotPassword();
